...
def read_file():
    with open('part_3 (save file).txt', 'r') as f:
        output = f.read()
        print(output)
    
#------reference for read_file :- https://www.pythontutorial.net/python-basics/python-read-text-file/       
    ...
    while True:
        ...
        if further_more == "y":
           ...
           continue
            ...
            with open('part_3 (save file).txt', 'w') as f:
                print("-" * 60, "\nHistogram") 
                ...
                for progression_data in progress_list:  # Getting progression data from progress list and printing the data
                    ...
                    f.write(f"{output}\n")   # Saving progression list data to the textfile
                    print(output)
                print("\n")
                break
